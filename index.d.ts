...
/**
* Interface for generating gamma distributed pseudorandom numbers with pre-specified parameter values.
*/
...
/**
* Interface for generating gamma distributed pseudorandom numbers without pre-specified parameter values.
*/
...
interface Random extends PRNG {
	...
	*
	* @example
	* var mygamma = gamma.factory( 1.5, 1.5 );
	*
	* var v = mygamma();
	* // returns <number>
	*
	* @example
	* var mygamma = gamma.factory( 2.0, 3.0, {
	*     'seed': 297
	* });
	* var v = mygamma();
	* // returns <number>
	...
	*
	* @example
	* var mygamma = gamma.factory();
	*
	* var v = mygamma( 1.5, 1.5 );
	* // returns <number>
	*
	* @example
	* var mygamma = gamma.factory({
